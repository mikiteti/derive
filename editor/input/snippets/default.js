const defaultSnippets = [
    ...
    { from: /\\(${GREEK}|${SYMBOL}) ddot/, to: "\\ddot{\\[[0]]}", in: "rmA" },
    ...
    { from: /([a-zA-Z])ddot/, to: "\\ddot{[[0]]}", in: "rmA", priority: 1 },
    ...
    { from: "der", to: "\\frac{d ${0:y}}{d ${1:x}} ${2}", in: "mA" },
    { from: /dd(\d)/, to: "\\frac{d^{[[0]]} ${0:y}}{d ${1:x}^{[[0]]}} ${2}", in: "mA" },
    { from: "ddn", to: "\\frac{d^{${0:n}} ${1:y}}{d ${2:x}^{${0:n}}} ${3}", in: "mA" },
    { from: "ddt", to: "\\frac{d}{dt} ", in: "mA" },
    ...
    { from: "infi", to: "\\int_{-\\infty}^{\\infty} ${0} \\, d${1:x} ${2}", in: "mA" },
