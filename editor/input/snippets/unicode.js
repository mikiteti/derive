class DefaultSnippets {
    constructor(editor) {
        ...
        this.snippets = [
            ...
            { from: /([A-Z])rm/, to: "\\mathrm{[[0]]}", in: "rmA" },
            ...
            { from: "frak", to: "\\mathfrak{${0}}${1}", in: "mA" },
            ...
            { from: /\\(${TRIG})([A-Za-gi-z])/, to: "\\[[0]] [[1]]", in: "rmA", description: "Add space after trig funcs. Skips letter h to allow sinh, cosh, etc.", priority: 1 },
